"""Helper routines to seed the Ethernet/IP simulation registry."""
...
def seed_from_registers(registers: Iterable[Register]) -> None:
    seed_protocol_registers("ethernetip", registers)


def activate_plc_simulation(plc: PLC, registers: Iterable[Register]) -> None:
    activate_protocol_simulation("ethernetip", plc, registers)
